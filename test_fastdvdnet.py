...
def test_fastdvdnet(**args):
	...
	model_temp = torch.load('models/fastdvdnet_5.pth')
	...
	# print("psnr between denframes and orign ", psnr)
	psnr_noisy = batch_psnr(seqn.squeeze(), seq, 1.)
	# print("psnr between seq+n and orign ", psnr_noisy)
...
if __name__ == "__main__":
	...
	parser.add_argument("--model_file", type=str,\
						default="./logs/ckpt_e11.pth", \
						help='path to model of the pretrained denoiser')
	parser.add_argument("--test_path", type=str, default="images/hypersmooth/", \
	...
	parser.add_argument("--noise_sigma", type=float, default=5, help='noise level used on test set')
