...
class FastDVDnet(nn.Module):
	...
	def forward(self, x, noise_map):
		...
		if self.num_input_frames == 3:
			...
			x20 = self.temp1(x0, x1, in2 = None, noise_map = noise_map)
			x21 = self.temp1(x0, x2, in2 = None, noise_map = noise_map)
			x22 = self.temp1(x1, x2, in2 = None, noise_map = noise_map)
		#Second stage
